...
// Define the mount path where the secret file is located
const mountPath = '/secrets/googleServiceAccountKey.json';

// Read the file contents
const fileContents = fs.readFileSync(mountPath, 'utf8');

// Evaluate the file contents as TypeScript code and capture the exports
const serviceAccount = eval(fileContents);
